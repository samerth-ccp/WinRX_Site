@if(!empty($lines))
    @foreach($lines as $l=>$line)
        ...
        <div class="olb_block" data-product="{{$line['key']}}">
            <div class="olb_info">
                <div class="olb_img"> <a href="{{ route('frontend.static.productdetail', ['pid' => $line['product_slug']]) }}"><img src="{{asset('assets/storage/products/'.$line['product_image'])}}" alt="img"></a> </div>
                <div class="olb_detail">
                    <p class="p_name"> <a href="{{ route('frontend.static.productdetail', ['pid' => $line['product_slug']]) }}" class="p_name">{{$line['product_name']}}</a> </p>
