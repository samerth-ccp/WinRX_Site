                        ...
                        <div class="d-flex align-items-start mt-3 mt-sm-0">
                            <div class="flex-shrink-0">
                                <div class="avatar-xl me-3">
                                    <img src="{{ getUserImage($userData->image) }}" alt="" class="img-fluid rounded-circle d-block">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div>
                                    <h5 class="font-size-16 mb-1">{{ $userData->name }}</h5>
                                    <p class="text-muted font-size-13">{{ $userData->email }}</p>
            ...
            <div class="card-body">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="#" class="list-group-item list-group-item-action">
                        <div class="d-flex align-items-center">
                            <div class="avatar-sm flex-shrink-0 me-3">
                                <img src="{{ URL::asset('/assets/images/users/avatar-3.jpg') }}" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <div class="flex-grow-1">
                                <div>
