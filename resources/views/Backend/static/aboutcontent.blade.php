...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('backend.removeaboutcontent') }}" onsubmit="return checkSelects('Form')" id="Form">
                    @csrf
                    {{--  ADD Edit Button  --}}
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{ route('backend.manageaboutcontent') }}"><button type="button" class="btn btn-primary waves-effect waves-light add-section">
                            Add About Content
                        </button></a>
...
<script>
    ...
    $(document).ready(function(){
        $("#datatable").DataTable({
            ...
            "sAjaxSource": "{{ route('backend.getaboutcontent')}}",
            "iDisplayLength":10,
