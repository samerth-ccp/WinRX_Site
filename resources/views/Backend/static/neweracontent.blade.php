...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('backend.removeneweracontent') }}" onsubmit="return checkSelects('Form')" id="Form">
                    @csrf
                    {{--  ADD Edit Button  --}}
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{ route('backend.manageneweracontent') }}"><button type="button" class="btn btn-primary waves-effect waves-light add-section">
                            Add New ERA Content
                        </button></a>

                        <button type="submit" class="btn btn-danger waves-effect waves-light">
                            Delete New ERA Content
                        </button>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                ...
                                <th><i data-feather="calendar"></i> Heading</th>
                                <th><i data-feather="calendar"></i> Tag Line</th>
...
<script>
    ...
    $(document).ready(function(){
        $("#datatable").DataTable({
            ...
            "sAjaxSource": "{{ route('backend.getneweracontent')}}",
            "iDisplayLength":10,
