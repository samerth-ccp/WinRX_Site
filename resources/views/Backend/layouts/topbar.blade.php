        ...
        <div class="d-flex w-100">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('backend.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('assets/storage/logo/').'/'.Session::get('ConfigData')['site_fav_icon']}}" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/storage/logo/').'/'.Session::get('ConfigData')['site_icon'] }}" style="max-width:165px;" alt="" height="40"> {{-- <span class="logo-txt">{{Session::get('ConfigData')['site_name']}}</span> --}}
                    </span>
                </a>
 ...
 --}}
            ...
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ isset(Session::get('AdminData')->profile_image) ? asset('assets/storage/avtar/').'/'.Session::get('AdminData')->profile_image : asset('/assets/images/users/default-user.png') }}" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ isset(Session::get('AdminData')->name) ? ucfirst(Session::get('AdminData')->name) : 'Admin'}}</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('backend.adminprofile') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> @lang('Profile')</a>
                    <a class="dropdown-item" href="{{ route('backend.resetpassword') }}"><i class="mdi mdi-lock-reset font-size-16 align-middle me-1"></i> Reset Password </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="{{ route('backend.logout') }}"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> <span key="t-logout">Logout</span></a>
                </div>
            </div> --}}
