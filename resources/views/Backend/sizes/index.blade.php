...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('delete.sizes') }}" onsubmit="return checkSelects('Form')" id="Form">
                    @csrf
                    <!--  Add Delete Button  -->
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{ route('manage.sizes') }}"><button type="button" class="btn btn-primary waves-effect waves-light"><i data-feather="plus"></i> Add Size</button></a>
                        <button type="submit" class="btn btn-danger waves-effect waves-light"><i data-feather="minus"></i> Delete Size </button>
                    </div>
