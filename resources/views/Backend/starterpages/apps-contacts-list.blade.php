...
@section('title') @lang('User_List') @endsection
    ...
    <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <img src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
            ...
            <tr>
                ...
                <td>
                    <img src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
