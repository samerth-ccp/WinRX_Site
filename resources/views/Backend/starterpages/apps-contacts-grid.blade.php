    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="mx-auto mb-4">
                    <img src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-xl rounded-circle img-thumbnail">
                </div>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="mx-auto mb-4">
                    <img src="{{ URL::asset('/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xl rounded-circle img-thumbnail">
                </div>
