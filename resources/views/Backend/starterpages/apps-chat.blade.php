...
@section('title') @lang('Chat') @endsection
        ...
        <div class="p-3 px-4 border-bottom">
            <div class="d-flex align-items-start ">
                <div class="flex-shrink-0 me-3 align-self-center">
                    <img src="{{ asset('assets/images/users/avatar-1.jpg') }}" class="avatar-sm rounded-circle" alt="">
                </div>
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img online align-self-center me-3">
                                                <img src="{{ asset('assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-sm" alt="">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="{{ asset('assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
