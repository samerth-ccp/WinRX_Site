...
@section('title') @lang('Images') @endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><span>*****</span> Image Sizes</h4>
                <p class="card-title-desc">Images in Bootstrap are made responsive
                    with <code class="highlighter-rouge">.img-fluid</code>. <code class="highlighter-rouge">max-width: 100%;</code> and <code class="highlighter-rouge">height: auto;</code> are applied to
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-end">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-md" src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Generic placeholder image">
                    </div>
                    <div class="flex-grow-1">
