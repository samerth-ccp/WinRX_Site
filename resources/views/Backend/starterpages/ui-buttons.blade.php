...
@section('title') @lang('Buttons') @endsection
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">Replace the default modifier classes with the <code class="highlighter-rouge">.btn-outline-*</code> ones to remove all background images and colors on any
                    button.
                </p>
            </div><!-- end card header -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc"><span>*****</span>Use class <code>btn-soft-*</code> for button round border.</p>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><span>*****</span> Block Buttons</h4>
                <p class="card-title-desc">Create block level buttons—those that span the full width of a parent—by adding
                    <code class="highlighter-rouge">.d-grid</code>.
                </p>
            </div><!-- end card header -->
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">Wrap a series of buttons with <code class="highlighter-rouge">.btn</code> in <code class="highlighter-rouge">.btn-group</code>.
                </p>
            </div><!-- end card header -->
