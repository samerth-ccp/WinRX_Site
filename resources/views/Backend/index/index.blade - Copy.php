    ...
    <div class="row">
       ...
       <div class="card">
           <div class="card-header">
               <h4 class="card-title mb-0">User Registration in:&nbsp;
               <select name="chart_type" id="chart_type" class="form-control" style="max-width:150px;padding: 2px 5px;
   display: inline-flex;appearance:auto;  ">
                   <option value="chart_days">Last 7 days</option>
                   <option value="chart_month">1 Month</option>
                   <option value="{{date('Y')}}">This Year</option>
                   @php
                   for($i=date('Y')-1;$i>=date('Y')-10;$i--){ @endphp
           ...
           <div class="card-body" >
               <div id="column_chart1" data-colors='["#4ba6ef"]' class="apex-charts" dir="ltr"></div>
           </div>
       </div>
       <!--end card-->
   </div>
